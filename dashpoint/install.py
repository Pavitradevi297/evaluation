...
def after_install():
    # Create the three required Delivery Zones if missing.
    ...
    # Create the Single Dispatch Settings record with required defaults.
    ...
    # Create the default Letter Head idempotently.
